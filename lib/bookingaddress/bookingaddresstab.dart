...
class BookingAddressTab extends StatefulWidget {
  const BookingAddressTab({super.key});

  @override
  State<BookingAddressTab> createState() => _BookingAddressTabState();
}
...
class BookingAddressTabPage extends StatelessWidget {
  const BookingAddressTabPage({super.key});
